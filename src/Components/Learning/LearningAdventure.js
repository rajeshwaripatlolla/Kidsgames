// src/pages/LearningAdventure.jsx
import React from "react";
import "./LearningAdventure.css";

const LearningAdventure = () => {
  // ABC Data
  const alphabet = [
    "A - Apple", "B - Ball", "C - Cat", "D - Dog", "E - Elephant", 
    "F - Fish", "G - Grapes", "H - Hat", "I - Ice", "J - Jug", 
    "K - Kite", "L - Lion", "M - Monkey", "N - Nose", "O - Orange", 
    "P - Parrot", "Q - Queen", "R - Rabbit", "S - Sun", "T - Tiger", 
    "U - Umbrella", "V - Van", "W - Wolf", "X - Xylophone", "Y - Yak", 
    "Z - Zebra"
  ];
  ...
  return (
    <div className="game-page">
      ...
      <p className="description">Let's learn the ABCs and 123s in a fun and interactive way!</p>
